...
class ApplicationState {
  ...
  @action updateExampleStateValue(newValue){ this._exampleStateValue = newValue };
  @computed get exampleStateValue(){ return this._exampleStateValue };

  @action updatePersistedVariable(newValue){ this._APersistedVariable = newValue };
  @computed get APersistedVariable(){ return this._APersistedVariable };
